    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="main-box clearfix">
                ...
                VALUES('$fullName', '$Department', '$Email', '$Member', '$date')";
                        ...
                        foreach ($studentInfo as $Student) {
                            ...
                            echo "<a href='#' class='user-link'>$StudentName</a>";
                            echo "<span class='user-subhead'>$RoleID</span>";
                            echo "</td>";
